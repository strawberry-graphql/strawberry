...
class GraphQLCoreConverter:
    ...
    def _get_thunk_mapping(
        type_definition: StrawberryObjectType,
    ...
    def get_graphql_fields(
        self, type_definition: StrawberryObjectType
    ...
    def from_input_object(self, object_type: type) -> GraphQLInputObjectType:
        type_definition = object_type.__strawberry_object__  # type: ignore
    ...
    def from_interface(self, interface: StrawberryObjectType) -> GraphQLInterfaceType:
    ...
    def from_object(self, object_type: StrawberryObjectType) -> GraphQLObjectType:
    ...
    def _get_is_type_of(
        self,
        object_type: StrawberryObjectType,
    ...
    def validate_same_type_definition(
        ...
        if (
            isinstance(type_definition, StrawberryObjectType)
            and isinstance(cached_type.definition, StrawberryObjectType)
        ...
        if isinstance(type_definition, StrawberryObjectType):
        ...
        if isinstance(cached_type.definition, StrawberryObjectType):
