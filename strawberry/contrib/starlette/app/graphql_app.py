...
from strawberry.middleware import TracingMiddleware
...
class GraphQLApp(BaseApp):
    def __init__(self, schema, playground: bool = True, tracing: bool = False) -> None:
        self.schema = schema
    ...
    async def handle_graphql(self, request: Request) -> Response:
        ...
        if self.tracing:
            ...
            middleware = MiddlewareManager(tracing)
            additional_arguments["middleware"] = middleware
        ...
        if self.tracing:
            tracing.end()
            extensions["tracing"] = tracing.tracing_dict
