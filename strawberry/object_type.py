...
from .utils.dataclasses import DataclassArguments, add_custom_init_fn
...
def _wrap_dataclass(cls: Type[Any], **kwargs: Unpack[DataclassArguments]):
    ...
    dclass = dataclasses.dataclass(**dclass_kwargs)(cls)  # type: ignore[arg-type]
