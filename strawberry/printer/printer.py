...
def print_schema_definition(schema: BaseSchema, *, extras: PrintExtras) -> Optional[str]:
...
def print_directive(directive: GraphQLDirective, *, schema: BaseSchema) -> Optional[str]:
