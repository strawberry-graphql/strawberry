...
class Schema(BaseSchema):
    ...
    def _get_federation_query_type(self, query: Optional[Type]) -> Type:
        ...
        if query.__strawberry_object__.extend:
            query_type.__strawberry_object__.extend = True  # type: ignore
    ...
    def entities_resolver(
        ...
        for representation in representations:
            ...
            definition = cast(StrawberryObjectType, type_.definition)
...
def _get_entity_type(type_map: "TypeMap"):
    ...
    def _resolve_type(self, value, _type):  # noqa: ANN001
        return self.__strawberry_object__.name
...
def _has_federation_keys(
    definition: Union[
        StrawberryObjectType, "ScalarDefinition", "EnumDefinition", "StrawberryUnion"
    ]
) -> bool:
    if isinstance(definition, StrawberryObjectType):
