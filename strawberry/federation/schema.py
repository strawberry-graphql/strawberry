...
class Schema(BaseSchema):
    ...
    def entities_resolver(
        ...
        for representation in representations:
            ...
            definition = cast(StrawberryObject, type_.definition)
...
def _has_federation_keys(
    definition: Union[
        StrawberryObject, "ScalarDefinition", "EnumDefinition", "StrawberryUnion"
    ]
) -> bool:
    if isinstance(definition, StrawberryObject):
