...
If you'd like to persist this kind of metadata in your response, you'll need to add a `GraphQLError` with that data yourself, commonly accomplished with the `located_error()` function.
