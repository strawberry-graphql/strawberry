...
def test_enum():
    ...
    field = get_type_definition(Animal).fields[0]
...
def test_forward_reference():
    ...
    field = get_type_definition(TimeTraveler).fields[0]
...
def test_list():
    ...
    field = get_type_definition(Santa).fields[0]
...
def test_literal():
    ...
    field = get_type_definition(Fabric).fields[0]
...
def test_object():
    ...
    field = get_type_definition(TransitiveVerb).fields[0]
...
def test_optional():
    ...
    field = get_type_definition(HasChoices).fields[0]
...
def test_type_var():
    ...
    strawberry_definition = get_type_definition(Gossip)
...
def test_union():
    ...
    strawberry_definition = get_type_definition(WishfulThinking)
    field = strawberry_definition.fields[0]
