...
def test_a():
    ...
    [field] = Query.__strawberry_object__.fields
...
def test_c_composition_by_name():
    [
        ...
        a_method,
        b_method,
    ] = c_mod.CCompositionByName.__strawberry_object__.fields
...
def test_c_inheritance():
    [
        ...
        b_age,
        b_is_of_full_age,
    ] = c_mod.CInheritance.__strawberry_object__.fields
...
def test_c_composition_resolver():
    ...
    [a_field, b_field] = field.type.of_type.__strawberry_object__.fields
    assert a_field.type == List[a_mod.AObject]
    assert b_field.type == List[b_mod.BObject]
...
def test_c_composition_by_name_with_resolvers():
    [
        a_field,
        b_field,
    ] = c_mod.CCompositionByNameWithResolvers.__strawberry_object__.fields
    assert a_field.type == List[a_mod.AObject]
    assert b_field.type == List[b_mod.BObject]
...
def test_c_composition_by_name_with_typeless_resolvers():
    [
        a_field,
        b_field,
    ] = c_mod.CCompositionByNameWithTypelessResolvers.__strawberry_object__.fields
    assert a_field.type == List[a_mod.AObject]
    assert b_field.type == List[b_mod.BObject]
...
def test_c_composition_only_resolvers():
    [
        a_field,
        b_field,
    ] = c_mod.CCompositionOnlyResolvers.__strawberry_object__.fields
    assert a_field.type == List[a_mod.AObject]
    assert b_field.type == List[b_mod.BObject]
...
def test_x_resolver():
    ...
    [c_field] = Query.__strawberry_object__.fields
