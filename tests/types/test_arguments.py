...
def test_basic_arguments():
    ...
    assert definition.fields[0].arguments[0].name is None
    assert definition.fields[0].arguments[0].origin_name == "argument"
    assert definition.fields[0].arguments[0].type == str
    assert definition.fields[0].arguments[0].is_optional is False

    assert definition.fields[0].arguments[1].origin_name == "optional_argument"
...
def test_input_type_as_argument():
    ...
    assert definition.fields[0].arguments[0].origin_name == "input"
    assert definition.fields[0].arguments[0].type == Input
    assert definition.fields[0].arguments[0].is_optional is False

    assert definition.fields[0].arguments[1].origin_name == "optional_input"
...
def test_arguments_lists():
    ...
    assert definition.fields[0].arguments[0].origin_name == "inputs"
...
def test_basic_arguments_on_resolver():
    ...
    assert definition.fields[0].arguments[0].origin_name == "id"
    assert definition.fields[0].arguments[0].type == strawberry.ID
    assert definition.fields[0].arguments[0].is_optional is False

    assert definition.fields[0].arguments[1].origin_name == "argument"
    assert definition.fields[0].arguments[1].type == str
    assert definition.fields[0].arguments[1].is_optional is False

    assert definition.fields[0].arguments[2].origin_name == "optional_argument"
...
def test_arguments_when_extending_multiple_types():
    ...
    assert definition.fields[1].arguments[0].origin_name == "id"
...
def test_argument_with_default_value_none():
    ...
    assert argument.origin_name == "argument"
