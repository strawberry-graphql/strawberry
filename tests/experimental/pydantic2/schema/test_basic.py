...
def test_basic_type_with_nested_model():
    ...
    @strawberry.experimental.pydantic2.type(Hobby, all_fields=True)
    class HobbyType:
        pass
...
def test_basic_type_with_union():
    ...
    @strawberry.experimental.pydantic2.type(BranchA, all_fields=True)
    class BranchAType:
        pass

    @strawberry.experimental.pydantic2.type(BranchB, all_fields=True)
    class BranchBType:
        pass
...
def test_basic_type_with_interface():
    ...
    @strawberry.experimental.pydantic2.interface(Base, all_fields=True)
    class BaseType:
        pass
