...
def test_referencing_other_input_models_fails_when_not_registered():
    ...
    @strawberry.experimental.pydantic2.type(Group)
    class GroupType:
...
def test_list_of_types():
    ...
    @strawberry.experimental.pydantic2.type(Friend)
    class FriendType:
        name: strawberry.auto
...
def test_default_and_default_factory():
    ...
    @strawberry.experimental.pydantic2.type(User1)
    class UserType1:
    ...
    @strawberry.experimental.pydantic2.type(User2)
    class UserType2:
        friend: strawberry.auto
    ...
    @strawberry.experimental.pydantic2.type(User3)
    class UserType3:
        friend: strawberry.auto
    ...
    @strawberry.experimental.pydantic2.type(User4)
    class UserType4:
        friend: strawberry.auto
...
def test_type_with_aliased_pydantic_field():
    ...
    @strawberry.experimental.pydantic2.type(UserModel)
    class User:
...
def test_union():
    ...
    @strawberry.experimental.pydantic2.type(BranchA)
    class BranchAType:
        field_a: strawberry.auto

    @strawberry.experimental.pydantic2.type(BranchB)
    class BranchBType:
...
def test_interface():
    ...
    @strawberry.experimental.pydantic2.interface(Base)
    class BaseType:
...
def test_both_output_and_input_type():
    ...
    @strawberry.experimental.pydantic2.input(Work)
    class WorkInput:
        time: strawberry.auto

    @strawberry.experimental.pydantic2.type(Work)
    class WorkOutput:
        time: strawberry.auto
    ...
    @strawberry.experimental.pydantic2.input(Group)
    class GroupInput:
...
def test_alias_fields_with_use_pydantic_alias():
    ...
    @strawberry.experimental.pydantic2.type(User, use_pydantic_alias=True)
    class UserType:
        age: strawberry.auto = strawberry.field(name="ageAlias")
