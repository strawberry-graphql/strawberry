...
from strawberry.experimental.pydantic.pydantic_type_extension import (
    PydanticTypeExtension,
)
...
def test_simple_type():
    ...
    class UserType:
        id: str
        a: strawberry.auto
        b: strawberry.auto = strawberry.field(default="b")
        pass
...
def test_referencing_other_input_models_fails_when_not_registered():
    ...
    @strawberry.type(extensions=[PydanticTypeExtension(model=Group)])
    class GroupType:
...
def test_list_of_types():
    ...
    @strawberry.type(extensions=[PydanticTypeExtension(model=Friend)])
    class FriendType:
        name: strawberry.auto
...
def test_default_and_default_factory():
    ...
    @strawberry.type(extensions=[PydanticTypeExtension(model=User1)])
    class UserType1:
    ...
    @strawberry.type(extensions=[PydanticTypeExtension(model=User2)])
    class UserType2:
        friend: strawberry.auto
    ...
    @strawberry.type(extensions=[PydanticTypeExtension(model=User3)])
    class UserType3:
        friend: strawberry.auto
    ...
    @strawberry.type(extensions=[PydanticTypeExtension(model=User4)])
    class UserType4:
        friend: strawberry.auto
...
def test_type_with_aliased_pydantic_field():
    ...
    @strawberry.type(extensions=[PydanticTypeExtension(model=UserModel)])
    class User:
...
def test_union():
    ...
    @strawberry.type(extensions=[PydanticTypeExtension(model=BranchA)])
    class BranchAType:
        field_a: strawberry.auto

    @strawberry.type(extensions=[PydanticTypeExtension(model=BranchB)])
    class BranchBType:
...
def test_interface():
    ...
    @strawberry.interface(extensions=[PydanticTypeExtension(model=Base)])
    class BaseType:
