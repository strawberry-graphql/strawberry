...
def test_convert_alias_name():
    ...
    user = User.from_pydantic(origin_user)
    assert user.age_ == 1
    definition = User.__strawberry_object__
...
def test_can_convert_input_types_to_pydantic_default_values_defaults_declared_first():
    ...
    definition: StrawberryObjectDefinition = UserInput.__strawberry_object__
...
def test_can_convert_pydantic_type_to_strawberry_with_additional_field_resolvers():
    ...
    user = User.from_pydantic(origin_user)
    assert user.password == "abc"
    assert User.__strawberry_object__.fields[0].name == "age"
    assert User.__strawberry_object__.fields[0].base_resolver() == 42
    assert User.__strawberry_object__.fields[2].name == "new_age"
    assert User.__strawberry_object__.fields[2].base_resolver() == 84
...
def test_can_convert_generic_alias_fields_to_strawberry():
    ...
    fields = Test.__strawberry_object__.fields
