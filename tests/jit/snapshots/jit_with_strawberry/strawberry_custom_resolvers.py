    ...
    if field_posts_value is not None:
        if isinstance(field_posts_value, list):
            ...
            for item_posts in field_posts_value:
                ...
                field_wordCount_value = resolver(item_posts, info)
                item_posts_result["wordCount"] = field_wordCount_value
            ...
            field_wordCount_value = resolver(field_posts_value, info)
            single_item_result["wordCount"] = field_wordCount_value
            info.field_name = "author"
            info.parent_type = "Post"
