    ...
    if field_posts_value is not None:
        if isinstance(field_posts_value, list):
            ...
            for item_posts in field_posts_value:
                ...
                if info.variable_values.get('showDetails'):
                ...
                if not (info.variable_values.get('hidePublished')):
                ...
                if info.variable_values.get('showDetails'):
                    info.field_name = "views"
                    info.parent_type = "Post"
                    resolver = _resolvers['resolver_5']
                    field_views_value = resolver(item_posts, info)
                    item_posts_result["views"] = field_views_value
            ...
            if info.variable_values.get('showDetails'):
                ...
                field_views_value = resolver(field_posts_value, info)
                single_item_result["views"] = field_views_value
