...
def test_defining_interface():
    ...
    definition = Node.__strawberry_object__
...
def test_implementing_interfaces():
    ...
    assert definition.interfaces == [Node.__strawberry_object__]
...
def test_implementing_interface_twice():
    ...
    definition = Person.__strawberry_object__
...
def test_interfaces_can_implement_other_interfaces():
    ...
    assert UserNodeInterface.__strawberry_object__.is_interface is True
    assert UserNodeInterface.__strawberry_object__.interfaces == [
        Node.__strawberry_object__
    ]

    definition = Person.__strawberry_object__
    assert definition.is_interface is False
    assert definition.interfaces == [
        UserNodeInterface.__strawberry_object__,
        Node.__strawberry_object__,
    ]
