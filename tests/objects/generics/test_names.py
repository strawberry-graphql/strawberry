...
def test_name_generation(types, expected_name):
    ...
    type_definition = Example.__strawberry_object__  # type: ignore
...
def test_nested_generics():
    ...
    type_definition = Connection.__strawberry_object__  # type: ignore
...
def test_nested_generics_aliases_with_schema():
    ...
    type_definition = Value.__strawberry_object__  # type: ignore
