...
def test_extensions_schema_directive():
    ...
    graphql_scheme_directive = schema.schema_converter.from_schema_directive(
        Query.__strawberry_object__.directives[0]
    )
    assert (
...
def test_interface():
    ...
    assert (
        ...
        is Thing.__strawberry_object__
    )
