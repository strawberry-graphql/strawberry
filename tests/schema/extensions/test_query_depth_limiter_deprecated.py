...
from strawberry.extensions.query_depth_limiter import create_validator_deprecated
...
def run_query(query: str, max_depth: int, ignore=None):
    ...
    validation_rule = create_validator_deprecated(max_depth, ignore, callback)
