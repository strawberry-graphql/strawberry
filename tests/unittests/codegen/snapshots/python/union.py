...
OperationNameResultUnion = Union[
    OperationNameResultUnionAnimal, OperationNameResultUnionPerson
]
...
OperationNameResultOptionalUnion = Union[
    OperationNameResultOptionalUnionAnimal, OperationNameResultOptionalUnionPerson
]
